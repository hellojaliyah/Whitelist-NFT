...
contract BrownieBakers is ERC721Enumerable, Ownable {
    //  _price is the price of one Brownie Bakers NFT
    uint256 constant public _price = 0.01 ether;

    // Max number of BorwnieBakers that can ever exist
    ...
    /**
      ...
      * name in our case is `BrownieBakers` and symbol is `BRB`.
      * Constructor for Brownie Bakers takes in the baseURI to set _baseTokenURI for the collection.
      * It also initializes an instance of whitelist interface.
      */
    constructor (address whitelistContract) ERC721("Brownie Bakers", "BRB") {
